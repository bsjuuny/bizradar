    ...
    <main className="mx-auto flex min-h-screen w-full max-w-2xl flex-col gap-8 px-4 py-12">
      ...
      <section className={SECTION_CLASS}>
        ...
        <p className={BODY_CLASS}>
          ...
          아닌 매칭 서비스 제공을 위한 사업 정보입니다. 설정 화면에서 텔레그램 Watch
          다이제스트 알림을 신청하는 경우 텔레그램 Chat ID를 선택적으로 추가 수집하며,
          이는 알림 발송 목적으로만 이용됩니다(미입력 시에도 서비스 이용에 제한이
          없습니다).
        </p>
      </section>
      ...
      <section className={SECTION_CLASS}>
        ...
        <p className={BODY_CLASS}>
          회원 식별 및 인증, 서비스 제공(공공 IT 프로젝트 매칭, 대시보드 제공), Watch
          조건에 맞는 신규 공고를 텔레그램으로 안내(선택 신청자에 한함), 이용자 문의
          대응을 위한 목적으로만 개인정보를 수집·이용합니다. 수집한 개인정보는 명시한
          목적 외의 용도로 이용하지 않습니다.
        </p>
      </section>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="px-3 py-2 text-muted-foreground">
                  Watch 다이제스트 알림을 신청한 이용자에게 텔레그램 메시지 발송
                  (Chat ID를 등록한 경우에 한함)
                </td>
              </tr>
            </tbody>
      ...
      <section className={SECTION_CLASS}>
        ...
        <p className={BODY_CLASS}>
          ...
          리전 확정 후 본 방침에 구체적으로 반영합니다. 또한 Watch 다이제스트 알림을
          신청한 이용자에 한해, 등록한 텔레그램 Chat ID와 알림 메시지 내용이 Telegram의
          서버(해외 소재)로 전송됩니다. 정확한 서버 소재 국가는 Telegram 측 정책에
          따르며, 확인되는 대로 본 방침에 반영합니다.
        </p>
      </section>
